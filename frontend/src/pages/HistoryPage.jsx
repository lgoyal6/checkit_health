    ...
    <div>
      <div className="flex items-center justify-between gap-4">
        ...
        <select
          ...
          aria-label="Filter claim history by review status"
              ...
              {visible.map((r) => {
                ...
                return (
                  <Fragment key={r.post_id}>
                    <tr className="hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-right">
                        <button
                          ...
                          aria-controls={`history-details-${r.post_id}`}
                          className="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition-colors hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2"
                        >
                    ...
                    {isOpen && (
                      <tr id={`history-details-${r.post_id}`} className="bg-slate-50">
